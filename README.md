...
# WIDGETS
Using certain BASIC scripts, create interfaces with Tkinter to select Archicad elements. These widgets do not trigger actions in Archicad; they serve as a basis for building other scripts.
Use the Tkinter interface because it is integrated into Python and does not require any additional downloads.
